...
struct qsort_args _qsort_args(size_t element_size, void *arr, int left,
                              int right, comparer cmp)
{
...
void _qsort(size_t element_size, void *arr, int left, int right, comparer cmp)
{
    ...
    if (right - left > THREAD_THRESHOLD) {
        ...
        if (0 == pthread_create(&lt, PTHREAD_CREATE_JOINABLE, _qsort_start,
                                (void *)&qa)) {
...
void _qsort_8(void *arr, int left, int right, comparer cmp)
{
    ...
    if (right - left > THREAD_THRESHOLD) {
        ...
        if (0 == pthread_create(&lt, PTHREAD_CREATE_JOINABLE, _qsort_8_start,
                                (void *)&qa)) {
...
void _qsort_4(void *arr, int left, int right, comparer cmp)
{
    ...
    if (right - left > THREAD_THRESHOLD) {
        ...
        if (0 == pthread_create(&lt, PTHREAD_CREATE_JOINABLE, _qsort_4_start,
                                (void *)&qa)) {
...
void _qsort_2(void *arr, int left, int right, comparer cmp)
{
    ...
    if (right - left > THREAD_THRESHOLD) {
        ...
        if (0 == pthread_create(&lt, PTHREAD_CREATE_JOINABLE, _qsort_2_start,
                                (void *)&qa)) {
...
void _qsort_1(void *arr, int left, int right, comparer cmp)
{
    ...
    if (right - left > THREAD_THRESHOLD) {
        ...
        if (0 == pthread_create(&lt, PTHREAD_CREATE_JOINABLE, _qsort_1_start,
                                (void *)&qa)) {
